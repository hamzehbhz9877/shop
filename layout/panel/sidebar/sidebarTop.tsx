    ...
    return (
        <div className="sidebar__top">
            <div className="sidebar__top-profile d-flex align-items-center position-relative">
                ...
                <img className="sidebar__top-profile-img"
                     ...
                     alt=""/>
                <div>
                    <h5 className="sidebar__top-profile-user-name fw-bold mb-0">حمزه بهرامی</h5>
                    <span className="sidebar__top-profile-phone-number fw-bold">09915648288</span>
                </div>
            ...
            <div className="sidebar__top-wallet d-flex align-baseline justify-content-between">
                <div>
                    <h5 className="sidebar__top-wallet-text fw-bold mb-0">کیف پول</h5>
                    <span role="button" className="sidebar__top-wallet-increase fw-bold mb-0">افزایش موجودی
                        <FaAngleLeft className="me-1"/>
                        </span>
                </div>
                <div>
                    <span className="fw-bold color-mischka sidebar__top-inventory">195000</span>
                    <ToomanIcon/>
                </div>
            </div>
        </div>
