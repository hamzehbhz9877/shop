        ...
        <div className="container h-100">
            <div className="d-flex gap-5  flex-column-reverse flex-sm-row h-100 justify-content-center justify-content-sm-between">
                <div className="align-self-center align-self-sm-end">
                    ...
                    <p className="footer__bottom-rights mb-0">کلیه حقوق این سایت متعلق به مهرپل میباشد.</p>
                </div>
                <div className="d-flex gap-2 footer__bottom-permissions shadow-sm align-self-center align-self-sm-end">
                    <div><img src="https://www.digikala.com/statics/img/png/rezi.png" alt=""/></div>
                    <div><img src="https://www.digikala.com/statics/img/png/kasbokar.png" alt=""/></div>
                    <div><img src="https://www.digikala.com/statics/img/png/enamad.png" alt=""/></div>
                </div>
            </div>
        </div>
        </div>
