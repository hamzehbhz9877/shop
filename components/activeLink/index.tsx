...
export default withRouter(({ router, children, as, href, activeClassName, ...rest }:any) => {
    ...
    const activityClassName = sanitizedPath === href || sanitizedPath === as ? activeClass || sanitizedPath.startsWith(href + "/") || sanitizedPath.startsWith(as + "/")  : "";
