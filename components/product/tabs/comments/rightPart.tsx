...
const RightPart = () => {
    return (
        <div className="pe-4 position-sticky top-0">
            <span><span className="fs-4">4.7</span><span> از 5</span></span>
            <div className="d-flex align-items-center"><StarRate/> <p className="color-mischka me-2 font-13">1163 نفر امتیاز داده اند</p></div>
            <LinearRate value={linearRate}/>

            <button className="btn product__add-comment color-pale-sky">
                <FaPlusCircle className="ms-2"/>
                شما هم نظر خود را بنویسید</button>
        </div>
    );
};
