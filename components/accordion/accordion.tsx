...
const Accordion = ({items}:AccordionType) => {
    return (
        <div className="card accordion shadow-sm">
                <ul>
                    <li className="d-inline-block"><FaHome className="accordion__icon-base"/>
                        <span role="button">صفحه اصلی</span></li>
                    {items.map((item,index)=><li className="d-inline-block" key={index}>
